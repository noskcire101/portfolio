  ...
  return (
    <>
      <div className="bg-[#000] py-20">
        <h2 className=" max-w-full text-center  bg-gradient-to-r from-[#f3f3f3] via-[#535353] to-[#000] bg-clip-text text-transparent text-4xl pb-5 sm:text-5xl  lg:text-7xl  font-black">
          Sample Projects
        </h2>
